package com.example.pharmacy_wayfinding_project.api.service
...
import com.example.pharmacy_wayfinding_project.api.dto.MetaDto
...
class KakaoAddressSearchServiceRetryTest extends AbstractIntegrationContainerBaseTest {
    ...
    private String inputAddress = "제주특별자치도 서귀포시 중앙로 85"
